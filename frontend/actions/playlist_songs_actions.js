...
import { removePresentationItem, addToPresentationItem } from './presentation_actions';
...
export const createSongToPlaylist = (playlistSong) => {
  return (dispatch) => {
    return PlaylistSongAPIUtil.createPlaylistSong(playlistSong).then((playlistSong) => dispatch(addSongToPlaylist(playlistSong)));
  };
};
